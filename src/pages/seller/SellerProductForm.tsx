        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <CardContent className="space-y-6 pt-6">
                ...
                <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                  <div className="space-y-0.5">
                    <Label htmlFor="free_shipping" className="text-sm font-semibold cursor-pointer">
                      Free Shipping
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Offer free delivery on this product
                    </p>
                  </div>
                  <Switch
                    id="free_shipping"
                ...
                {!form.free_shipping && (
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-sm font-semibold">Shipping Class</Label>
                      <Select
                        value={form.shipping_class}
                        onValueChange={(value) => setForm({ ...form, shipping_class: value })}
                      >
                        <SelectTrigger className="h-11">
                          <SelectValue />
                        </SelectTrigger>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="package_weight" className="text-sm font-semibold">
                      Package Weight (kg)
                    </Label>
                    <Input
                      id="package_weight"
                      ...
                      placeholder="Including packaging"
                      className="h-11"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="package_dimensions" className="text-sm font-semibold">
                      Package Dimensions
                    </Label>
                    <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="estimated_delivery" className="text-sm font-semibold">
          ...
          <TabsContent value="seo" className="space-y-6">
            <Card className="border-2 border-dashed border-primary/20">
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-2">
                  <Label htmlFor="meta_title" className="text-sm font-semibold">
                    Meta Title
                  </Label>
                  <Input
                    id="meta_title"
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    {form.meta_title.length}/60 characters (recommended max)
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    {form.meta_description.length}/160 characters (recommended max)
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button type="button" onClick={addTag} className="h-11">
                      Add Tag
                    </Button>
                  </div>
                  {form.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2">
                      {form.tags.map((tag) => (
                        <Badge
                          key={tag}
                          variant="secondary"
                          className="px-3 py-1 gap-2 cursor-pointer hover:bg-destructive hover:text-destructive-foreground"
                ...
                <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                  <div className="space-y-0.5">
                    <Label htmlFor="is_searchable" className="text-sm font-semibold cursor-pointer">
                      Searchable
                    </Label>
                    <p className="text-xs text-muted-foreground">
                      Product will appear in search results and category pages
                    </p>
                  </div>
                  <Switch
                    id="is_searchable"
                    checked={form.is_searchable}
                    onCheckedChange={(checked) => setForm({ ...form, is_searchable: checked })}
                  />
                </div>
              </CardContent>
            </Card>
